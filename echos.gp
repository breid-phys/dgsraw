...
set xrange [ 1.47135 : 4.25796 ] noreverse nowriteback
set x2range [ 1.47135 : 4.25796 ] noreverse nowriteback
set ylabel "" 0.000000,0.000000  ""
set y2label "" 0.000000,0.000000  ""
set yrange [ 23.3333 : 156.314 ] noreverse nowriteback
set y2range [ 23.3333 : 156.314 ] noreverse nowriteback
...
set loadpath 
plot 'echo.dat' using ($6<0 ? $4 :1/0):5 title 'O','echo.dat' using ($6>0 ? $4 :1/0):5 title 'X'
#    EOF
